...
class TestUserLogin:
    ...
    def test_login_user(self):
        create_user_request = CreateUserRequest(username="Max2x", password="Pas!sw0rd", role="ROLE_USER")
        ...
        login_user_request = LoginUserRequest(username="Max2x", password="Pas!sw0rd")
